...
from model.model_vlm_naflexvit import MiniMindVLM_naflexvit
...
class VLMDataset(Dataset):
    ...
    def __getitem__(self, index: int):
        ...
        image_inputs_list = [MiniMindVLM_naflexvit.image2tensor_traing(Image.open(io.BytesIO(img)), self.preprocess) for img in image_bytes]
