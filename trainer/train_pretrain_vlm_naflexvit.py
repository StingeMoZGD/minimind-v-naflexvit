...
# CUDA_VISIBLE_DEVICES=0,1,2 torchrun --master_port=29501 --nproc_per_node=3 train_pretrain_vlm1.py
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_weight', default='pretrain_vlm_naflexvit1', type=str, help="保存权重的前缀名")
    ...
    parser.add_argument('--max_seq_len', default=514, type=int, help="训练的最大截断长度")
    parser.add_argument('--use_moe', default=1, type=int, choices=[0, 1], help="是否使用MoE架构（0=否，1=是）")
    parser.add_argument("--data_path", type=str, default="/data1/yym/MINIMIND/minimind-v-dataset/pretrain_i2t.parquet", help="训练数据路径")
